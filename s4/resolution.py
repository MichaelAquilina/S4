...
class Resolution(object):
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            and self.to_client == other.to_client
            and self.from_client == other.from_client
    ...
    def get_resolution(key, sync_state, to_client, from_client):
        if sync_state.state in (SyncState.UPDATED, SyncState.NOCHANGES):
            ...
            return Resolution(
                Resolution.DELETE, to_client, None, key, sync_state.remote_timestamp
            )
        else:
